...
hmap = heatmap!(rand(10,20), colormap = :viridis)
cbar = Colorbar(fig, hmap, label = "value", hight= Relative(3.7/4))
fig[1, 1] = ax
fig[1, 2] = cbar
#save("/results/FigHeatCbarRight.svg", scene, pt_per_unit = 0.7);
save("FigHeatCbarRight.png", fig, px_per_unit = 2)
fig